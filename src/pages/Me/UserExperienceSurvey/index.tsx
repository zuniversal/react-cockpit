...
function UserExperienceSurvey() {
  const { issueList, getIssueListAsync } = useModel('me');
  useEffect(() => {
    getIssueListAsync();
  }, []);
  // 水印
  ...
  function submit(index) {
    radio = index + 1;
    setProblem1(issueList[0].issuesId);
    if (index === 1 || index === 2 || index === 0) {
      setProblem2(issueList[1].issuesId);
      setProblem3(issueList[2].issuesId);
      setState(false);
      setState1(true);
    } else {
      setProblem2(issueList[3].issuesId);
      setProblem3(issueList[4].issuesId);
      setState(false);
      setState1(false);
    }
  }
              ...
              <div>
                <div
                  ...
                  dangerouslySetInnerHTML={{
                    __html: issueList.length && issueList[0].issuesName,
                  }}
                />
                <div>
                  <Radio.Group>
                    {issueList.length &&
                      issueList[0].answerVOList.map((item, index) => {
                        return (
                  ...
                  <div>
                    ...
                    <div>
                      <div
                        className={styles.smallTitle}
                        dangerouslySetInnerHTML={{
                          __html: issueList.length && issueList[1].issuesName,
                        }}
                      />
                      <div>
                        <Radio.Group>
                          {issueList.length &&
                            issueList[1].answerVOList.map((item, index) => {
                              return (
                                <div className={styles.contexts} key={index}>
                                  <p>
                                    <input
                    ...
                    <div className={styles.btn_bottomMargin}>
                      <div
                        className={styles.smallTitle}
                        dangerouslySetInnerHTML={{
                          __html: issueList.length && issueList[2].issuesName,
                        }}
                      />
                      <Input
                        value={text}
                  ...
                  <div>
                    ...
                    <div>
                      <div
                        className={styles.smallTitle}
                        dangerouslySetInnerHTML={{
                          __html: issueList.length && issueList[3].issuesName,
                        }}
                      />
                      <div>
                        <Radio.Group>
                          {issueList.length &&
                            issueList[3].answerVOList.map((item, index) => {
                              return (
                                <div className={styles.contexts} key={index}>
                                  <p>
                                    <input
                    ...
                    <div className={styles.btn_bottomMargin}>
                      <div
                        className={styles.smallTitle}
                        dangerouslySetInnerHTML={{
                          __html: issueList.length && issueList[4].issuesName,
                        }}
                      />
                      <Input
                        value={text}
