...
const SortableList = SortableContainer((props) => {
  ...
  const onTouchStart2 = ({ itemIndex }) => {
    console.log(' onTouchStart2   ,   ： ', itemIndex);
...
const MetricDraggable = (props) => {
  ...
  const updateBeforeSortStart = (params) => {
    console.log(' updateBeforeSortStart   params,   ： ', params);
  };
  const shouldCancelStart = (params) => {
    console.log(' shouldCancelStart   params,   ： ', params);
    return false;
  };
  ...
  return (
    <div className="">
      ...
      <Grid
        ...
        onPropsRemove={props.onPropsRemove}
...
const MetricGrid = (props) => {
  ...
  const onPropsRemove = (params) => {
    console.log(' onPropsRemove    ： ', params); //
