...
import { getUrlParams, sendPagePoint } from '../../utils'
...
export function Introduce() {
  ...
  function handleClick() {
    location.href = data[tabIndex].pageUrl
  }
  const imgRef = useRef()
        ...
        <>
          <div className={style.introduceCon}>
            ...
            <div className={style.pageTitle}>
              {data[tabIndex] && data[tabIndex].title}
            </div>
            {type !== 'history' && (
          ...
          <div
            ...
            dangerouslySetInnerHTML={{
              __html: data[tabIndex] && data[tabIndex].content,
            }}
          ></div>
        </>
      )}
